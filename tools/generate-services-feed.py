...
DESCRIPTION_BY_SLUG_TIME = {
    ("first-visit", "60"): "Первый сеанс оздоровительного массажа со скидкой: знакомство с форматом работы, обсуждение запроса и мягкая работа с напряжением в теле.",
    ("back-neck", "45"): "Фокусная работа со спиной, плечевым поясом и шеей. Подходит при ощущении зажатости, усталости и напряжения после работы или нагрузок.",
    ("face", "45"): "Мягкий массаж лица: работа с жевательными мышцами, лбом, висками и шеей. Помогает расслабить лицо и снять напряжение.",
    ("classic", "60"): "Классический оздоровительный массаж для снижения мышечного напряжения, восстановления после нагрузки и ощущения лёгкости в теле.",
    ...
    ("lymph", "60"): "Мягкий ритмичный лимфодренажный массаж для ощущения лёгкости, снижения общей отёчности и спокойного восстановления.",
    ("lymph", "90"): "Лимфодренажный массаж 90 минут: спокойный формат с большим временем на проработку тела и восстановление.",
    ("relax", "60"): "Спокойный расслабляющий массаж для отдыха, снижения напряжения и восстановления после стресса или интенсивной недели.",
    ("relax", "90"): "Расслабляющий массаж 90 минут: больше времени на медленную, бережную и глубокую работу с напряжением в теле.",
    ("sport", "60"): "Спортивный массаж для людей, которые тренируются или много двигаются. Активный формат для восстановления после нагрузки.",
...
def write_feed(offers: list[Offer]) -> None:
    ...
    shop = add(root, "shop")
    add(shop, "name", "Оздоровительный массаж — Денис Пучков")
    ...
    add(categories, "category", "Массаж", id="1")

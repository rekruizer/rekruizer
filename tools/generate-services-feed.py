...
DESCRIPTION_BY_SLUG_TIME = {
    ("first-visit", "60"): "Первый сеанс массажа со скидкой: знакомство с форматом работы, обсуждение запроса и мягкая работа с напряжением в теле.",
    ...
    ("classic", "60"): "Классический массаж для снижения мышечного напряжения, восстановления после нагрузки и ощущения лёгкости в теле.",
